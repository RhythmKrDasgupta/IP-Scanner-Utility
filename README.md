A scalable IP reputation and threat intelligence utility designed for security teams and researchers.

This tool aggregates data from multiple intelligence providers to assess malicious activity, abuse history, anonymity usage (VPN/Proxy/Tor), and contextual network metadata. Built with performance and automation in mind, it supports asynchronous execution, structured output, and bulk scanning for real-world security operations.
